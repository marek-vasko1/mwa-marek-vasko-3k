  ...
  return (
    <div className="bg-white">
      ...
      <div className="grid sm:grid-cols-3 place-items-center mt-10 sm:ml-32 sm:mr-32">
        <div className="grid place-items-center mt-8 "><img src="" alt=" img" />
      ...
      <div className="grid place-items-center sm:mt-8">
        <button className="py-2 px-9 border sm:mb-16 rounded bg-[#BE6361] text-white mt-8">Learn more</button>
      </div>
